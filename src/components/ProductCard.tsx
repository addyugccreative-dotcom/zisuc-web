      ...
      >
        ...
        <div className="relative aspect-[4/5] overflow-hidden bg-[#FAF5F0] mb-3 flex items-center justify-center transition-colors duration-300 w-full border border-stone-200/20">
          ...
          {isSoldOut ? (
            ...
            <div className="absolute top-3 left-3 z-10 inline-flex items-center bg-[#AC1D22] text-white px-2 py-1 rounded-[4px] font-sans font-bold text-[9px] tracking-wide select-none shadow-xs">
              <svg className="w-3.5 h-3.5 mr-1 shrink-0" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path 
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-[#FAF5F0] mb-4 border flex items-center justify-center transition-colors duration-300" style={{ borderColor: `${colorText}10` }}>
        {/* Sale badge */}
        {discountPercent > 0 && (
          <div className="absolute top-2.5 left-2.5 z-10 inline-flex items-center bg-[#AC1D22] text-white px-2 py-1 rounded-[4px] font-sans font-bold text-[9px] tracking-wide select-none shadow-xs">
            <svg className="w-3.5 h-3.5 mr-1 shrink-0" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path 
                d="M2.5 8.5L8.5 2.5H13.5V7.5L7.5 13.5L2.5 8.5Z" 
                fill="#FCE7E7" 
