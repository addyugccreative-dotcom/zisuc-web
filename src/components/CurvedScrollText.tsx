...
export function CurvedScrollText() {
  ...
  return (
    <div 
      ref={containerRef} 
      className="w-full bg-white relative overflow-hidden py-10 sm:py-5 lg:py-8 select-none border-y border-stone-200/20 flex items-center justify-center"
      style={{ 
    ...
    >
      ...
      <style>{`
        ...
        */
        ...
        @media (min-width: 1024px) {
          .premium-serif-curve-text {
            font-size: 48px; /* Medium size on laptops */
      ...
      <div className={`w-full ${isMobile ? 'h-[110px]' : 'h-[150px] lg:h-[180px]'} flex items-center justify-center relative overflow-visible`}>
        <svg 
