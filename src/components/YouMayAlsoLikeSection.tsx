      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-5 lg:px-6 text-left">
        ...
        <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-4 lg:grid lg:grid-cols-4 xl:gap-[18px] pb-4">
          ...
          <div onClick={() => onProductClick?.(p1.id)} className="bg-white border border-stone-100 p-4 sm:p-5 flex flex-col group relative transition-shadow hover:shadow-lg cursor-pointer min-w-[85vw] sm:min-w-[300px] lg:min-w-0 snap-center">
            ...
            {p1.compareAtPrice && (
              <div className="absolute top-4 left-4 z-10">
                <span className="px-2 py-0.5 bg-[#DCE4FF] text-[#3B4BEF] text-[9px] font-mono font-bold tracking-wider uppercase select-none rounded-[3px]">
                  SALE
                </span>
              </div>
            )}
            ...
            <div className="w-full aspect-square bg-[#FAF6F3] flex items-center justify-center p-3 relative overflow-hidden">
              <img
                ...
                alt={p1.title}
                className="max-h-[250px] h-[85%] w-auto object-contain transition-transform duration-500 group-hover:scale-105"
            ...
            {/* Options Selection Dots */}
            <div className="flex items-center justify-start gap-1 mt-5 mb-3">
              {prod1Colors.map((swatch, idx) => (
                <button
                  key={idx}
                  type="button"
                  onClick={(e) => { e.stopPropagation(); setColorIdx1(idx); }}
                  className="w-4.5 h-4.5 rounded-full border flex items-center justify-center cursor-pointer"
                  style={{ borderColor: colorIdx1 === idx ? '#1c1917' : 'transparent' }}
                  title={swatch.name}
                >
                  <span
            ...
            {/* Metadata and Title */}
            <div className="text-left flex-grow flex flex-col justify-between mt-1">
              <div>
              ...
              <div className="flex items-baseline gap-2 mt-2.5 font-mono">
                <span className="text-stone-900 text-xs font-bold">
                  {convertAndFormatPrice(p1.price, activeCurrency)}
                </span>
                {p1.compareAtPrice && (
                  <span className="text-stone-400 text-[10px] line-through">
                    {convertAndFormatPrice(p1.compareAtPrice, activeCurrency)}
                  </span>
                )}
              </div>
            </div>
          ...
          <div onClick={() => onProductClick?.(p1.id)} className="bg-white border border-stone-100 p-4 sm:p-5 flex flex-col group relative transition-shadow hover:shadow-lg cursor-pointer min-w-[85vw] sm:min-w-[300px] lg:min-w-0 snap-center">
            ...
            {/* Options Selection Dots */}
            <div className="flex items-center justify-start gap-1 mt-5 mb-3">
              {prod2Colors.map((swatch, idx) => (
                <button
                  key={idx}
                  type="button"
                  onClick={(e) => { e.stopPropagation(); setColorIdx2(idx); }}
                  className="w-4.5 h-4.5 rounded-full border flex items-center justify-center cursor-pointer"
                  style={{ borderColor: colorIdx2 === idx ? '#1c1917' : 'transparent' }}
                  title={swatch.name}
                >
                  <span
                    className="w-3 h-3 rounded-full border border-stone-200"
            ...
            <div className="text-left flex-grow flex flex-col justify-between mt-1">
              ...
              <div className="flex items-baseline gap-2 mt-2.5 font-mono">
                <span className="text-stone-900 text-xs font-bold">
                  {convertAndFormatPrice(p2.price, activeCurrency)}
                </span>
                {p2.compareAtPrice && (
                  <span className="text-stone-400 text-[10px] line-through">
                    {convertAndFormatPrice(p2.compareAtPrice, activeCurrency)}
                  </span>
                )}
              </div>
            </div>
          ...
          <div onClick={() => onProductClick?.(p1.id)} className="bg-white border border-stone-100 p-4 sm:p-5 flex flex-col group relative transition-shadow hover:shadow-lg cursor-pointer min-w-[85vw] sm:min-w-[300px] lg:min-w-0 snap-center">
            ...
            {/* Options Selection Dots */}
            <div className="flex items-center justify-start gap-1 mt-5 mb-3">
              {prod3Colors.map((swatch, idx) => (
                <button
                  key={idx}
                  type="button"
                  onClick={(e) => { e.stopPropagation(); setColorIdx3(idx); }}
                  className="w-4.5 h-4.5 rounded-full border flex items-center justify-center cursor-pointer"
                  style={{ borderColor: colorIdx3 === idx ? '#1c1917' : 'transparent' }}
                  title={swatch.name}
                >
                  <span
                    className="w-3 h-3 rounded-full border border-stone-200"
            ...
            <div className="text-left flex-grow flex flex-col justify-between mt-1">
              ...
              <div className="flex items-baseline gap-2 mt-2.5 font-mono">
                <span className="text-stone-900 text-xs font-bold">
                  {convertAndFormatPrice(p3.price, activeCurrency)}
                </span>
                {p3.compareAtPrice && (
                  <span className="text-stone-400 text-[10px] line-through">
                    {convertAndFormatPrice(p3.compareAtPrice, activeCurrency)}
                  </span>
                )}
              </div>
            </div>
          ...
          <div onClick={() => onProductClick?.(p1.id)} className="bg-white border border-stone-100 p-4 sm:p-5 flex flex-col group relative transition-shadow hover:shadow-lg cursor-pointer min-w-[85vw] sm:min-w-[300px] lg:min-w-0 snap-center">
            ...
            {/* Options Selection Dots */}
            <div className="flex items-center justify-start gap-1 mt-5 mb-3">
              {prod4Colors.map((swatch, idx) => (
                <button
                  key={idx}
                  type="button"
                  onClick={(e) => { e.stopPropagation(); setColorIdx4(idx); }}
                  className="w-4.5 h-4.5 rounded-full border flex items-center justify-center cursor-pointer"
                  style={{ borderColor: colorIdx4 === idx ? '#1c1917' : 'transparent' }}
                  title={swatch.name}
                >
                  <span
                    className="w-3 h-3 rounded-full border border-stone-200"
            ...
            <div className="text-left flex-grow flex flex-col justify-between mt-1">
              ...
              <div className="flex items-baseline gap-2 mt-2.5 font-mono">
                <span className="text-stone-900 text-xs font-bold">
                  {convertAndFormatPrice(p4.price, activeCurrency)}
                </span>
                {p4.compareAtPrice && (
                  <span className="text-stone-400 text-[10px] line-through">
                    {convertAndFormatPrice(p4.compareAtPrice, activeCurrency)}
                  </span>
                )}
              </div>
            </div>
