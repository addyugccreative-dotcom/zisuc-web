...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      ...
      >
        <div className="w-full flex items-center justify-between px-6 md:px-10 lg:px-14 xl:px-16 py-4 relative min-h-[72px]">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 text-center z-10 flex items-center justify-center">
            ...
            >
              <img decoding="async" loading="lazy" src="/zisuc  logo.png" alt="ZISU'C Logo" className="h-6 md:h-8 w-auto object-contain" />
            </a>
          </div>

          {/* Right Action Menu Icons (Exactly like Image 1) */}
          <div className="flex items-center space-x-3 sm:space-x-4 select-none z-10">
            {/* Currency picker */}
            ...
            <button 
              ...
              className="p-1.5 hover:opacity-75 active:scale-95 transition text-stone-850 cursor-pointer" 
              aria-label="Search"
            >
            ...
            {/* Profile trigger */}
            <div className="hidden md:block p-1.5 hover:opacity-100 opacity-80 transition cursor-pointer text-stone-850" aria-label="Account profile">
