...
// Animated component for review percentage numbers
interface AnimatedPercentageProps {
  value: number;
}

const AnimatedPercentage: React.FC<AnimatedPercentageProps> = ({ value }) => {
                ...
                {[5, 4, 3, 2, 1].map((rating) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="w-8 text-right font-medium text-stone-600">
                        <AnimatedPercentage value={pct} />
                      </span>
                    </div>
                  );
                })}
                ...
                <div className="space-y-2">
                  ...
                  {(newImage || newVideo) && (
                    <div className="flex flex-wrap gap-4 pt-2">
                      ...
                      {newVideo && (
                        <div className="relative w-20 h-20 border border-stone-200 bg-[#FAF6F3] p-1">
                          <video src={newVideo} preload="metadata" playsInline className="w-full h-full object-cover" />
