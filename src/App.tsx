...
const MutedAutoplayVideo: React.FC<MutedAutoplayVideoProps> = ({ src, isMuted, className, poster }) => {
  ...
  useEffect(() => {
    ...
    if (video) {
      video.muted = isMuted;
      // Force play again if it got paused or to guarantee autoplay trigger inside sandboxed iframe
  ...
  return (
    <div className="relative min-h-screen bg-[#FAF5F0] text-stone-900 font-sans overflow-x-clip selection:bg-[#F2A183] selection:text-white">
      ...
      <div className="w-full flex-col min-h-screen">
        ...
        <div 
          className={`fixed left-1.5 sm:left-4 bottom-24 sm:bottom-auto sm:top-1/2 sm:-translate-y-1/2 z-40 flex flex-col items-center bg-white border border-stone-200/50 py-2 sm:py-4.5 px-0.5 sm:px-1 shadow-md rounded-[32px] gap-2.5 sm:gap-4.5 transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] w-7 sm:w-9 ${
        ...
        >
          ...
          <button 
            ...
            className="text-stone-850 hover:text-amber-500 transition-colors duration-300 flex items-center justify-center p-0.5 sm:p-1 rounded-full hover:bg-stone-50 cursor-pointer" 
            aria-label="Toggle visual theme"
          >
            <Moon className="w-3 h-3 sm:w-4 sm:h-4 text-stone-900" />
          </button>
        ...
        {activePage === 'home' ? (
          <div className="flex flex-col animate-fade-in">
            ...
            <section className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-[1530px] mx-auto w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 md:gap-6 bg-[#FAF5F0]">
              {[
            ...
            <section id="bestsellers-section" className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-[1530px] mx-auto w-full scroll-mt-6 border-t border-stone-200/50">
              <div className="flex flex-col md:flex-row justify-between items-baseline mb-8 gap-6">
                ...
                <div className="flex flex-row flex-nowrap items-center gap-4 sm:gap-8 font-sans overflow-x-auto scrollbar-none w-full md:w-auto -mx-6 px-6 md:mx-0 md:px-0 justify-end md:justify-start">
                  <button 
                    onClick={() => {
                      handleNavigate('home');
                    }}
                    className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-widest text-[#e76f51] hover:text-stone-900 transition-colors duration-200 cursor-pointer ml-auto"
                  >
                  ...
                  {videoReels.map((reel, idx) => {
                    ...
                    return (
                      <motion.div 
                        ...
                        className="flex flex-col group select-none cursor-pointer min-w-[75vw] sm:min-w-0 snap-center shrink-0"
                        onClick={() => {
                          if (matchedProd) {
        ...
        >
          ...
          <div className="w-full select-none relative z-10 py-6 sm:py-12 flex justify-center items-center">
            <h1 
          ...
          <div className="w-full border-t border-white/20 py-4 sm:py-5 flex flex-col lg:flex-row justify-between items-center text-[11px] sm:text-[13px] text-white/80 gap-4 sm:gap-6 select-none px-6 sm:px-12 relative z-20">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
              ...
              <div className="flex items-center gap-4 cursor-pointer font-sans text-[11px] sm:text-[13px] text-white/80">
